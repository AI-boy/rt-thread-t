...
extern rt_err_t rt_hw_adc_register(rt_adc_device_t adc,const char *name,  struct rt_adc_ops *ops, const void *user_data);
extern rt_err_t rt_device_adc_create(const char *name,  struct rt_adc_ops *ops, const void *user_data);
